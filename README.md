...
作为**创新业务方向的 AI 产品负责人**，从 0→1 主导多条创新 AI 产品线（**IP 智能化硬件**、**景区 AI 拍照**等），打通「产品定义 → 模型调优 → 规模化商业落地」的完整链路。
...
<!-- 自用备注（不显示）：定位=会落地的 AI 硬件/Agent 产品经理；公司项目不具名、压成一句经历；护城河=交叉点+真实落地+前瞻。 -->
